...
if(isset($_POST["new_code"])){
	...
	*/
	...
	$file 		= 	AC_DIR_LANG."en.lang.php";
	$newfile 	= 	AC_DIR_LANG.$new_lang.".lang.php";	
...
if(isset($_POST["modify_it"])){
	...
	//print_r($_POST["new_value"]);
	$filename =AC_DIR_LANG.$_REQUEST["code"].'.lang.php';
	...
	else	$warning="LANGUAGE FILE ".$_REQUEST["lang_file"]." MODIFIED";
	fclose($handle);
}
...
if(isset($_POST["delete_it"])){
	...
	if(file_exists(DIR_LANG.$_REQUEST["code"].".lang.php")){
		unlink(DIR_LANG.$_REQUEST["code"].".lang.php");
	...
	switch($_REQUEST["action"]){
		...
		//	$finish			=	$lang["finish"];
			...
			if(!is_writable(AC_DIR_LANG.$_REQUEST["code"].".lang.php")){
				...
				include(AC_DIR_LANG.$_REQUEST["code"].".lang.php");
