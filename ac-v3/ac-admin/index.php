...
//	define language
if(isset($_SESSION["admin_lang"]))	define("LANG", $_SESSION["admin_lang"]);
else 								define("LANG", AC_DEFAULT_LANG);
...
//	check that special states background image exists
//	TO DO
//echo AC_DIR_THEMES_ROOT."bg_days.png";
//if(!file_exists(AC_DIR_THEMES_ROOT."bg_days.png")) echo '<br>Background image <strong>'.AC_DIR_IMAGES."bg_days.png".' doesn\'t exist';
...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo AC_DIR_JS; ?>mootools-1.2.4.4-more.js"></script>
		<script type="text/javascript" src="js/formcheck/lang/<?php echo LANG; ?>.js"></script>
	...
	<div id="wrapper">
		...
		<div id="footer">
			...
			<ul>
				...
				<li><a href="http://groups.google.com/group/ajax-availability-calendar" target="_blank">Calendar Forum</a></li>
