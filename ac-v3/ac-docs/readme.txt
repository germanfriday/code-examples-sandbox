...
9. NEW - lang folder and files need write permissions (chmod 777) to be able to be administrated via admin
...
This script can work with any number of languages.
	...
	/******** NEW ***********/
	Languages can now be added via admin.
...
Roadmap:
 ...
 There are many things that it would be nice to add however here are a few:
1. Ability to add languages dynamically -DONE
2. State background colors to be defined in admin and NOT in css
3. jquery version (current version uses mootools)